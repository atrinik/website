...
Every media change updates `src/data/media.json` with exact source, revision,
digests, author, license, transformations, alt text, and notice. Every download
change uses an immutable owner release URL and complete compatibility/license
